...
|---|---|---|
| Techstars | $20K post-money convertible equity agreement for 5% common stock, plus a $200K uncapped MFN SAFE that converts at the next priced round of $1M or more and adds further dilution on top of the 5% (https://www.techstars.com/investment-terms, accessed 2026-09-05) | Google Cloud names Techstars among accelerators whose participants qualify for the Scale tier (cloud.google.com/startup text indexed 2026-09-05; medium confidence, confirm on page). Techstars' status as an AWS Activate Provider, or as a partner for Anthropic, Vercel, or Perplexity, was not verified here |
| 500 Global Flagship | $150K for 6%, 4-month program (third-party summary; confirm on 500 Global's current terms page) | Google Cloud names 500 Global among qualifying accelerators (same source and confidence as above). AWS, Anthropic, Vercel, and Perplexity partner status not verified here |
| Antler | ~$100–150K US pre-seed; region-specific terms; claims $650K+ in AI credits are unverified | Google Cloud names Antler among qualifying accelerators (same source and confidence as above). AWS, Anthropic, Vercel, and Perplexity partner status not verified here |
